...
<header>
    ...
    <div class="container-fluid">
        <div class="row top-bar">
            <span id="logo_title" class="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 "><div id="sitename">StartDaWay</div> <div id="sitepunchline">< StartUp <span>R</span>eferencer /></div></span>
